...
<body class="antialiased">
    <div
        ...
        <div class="flex">
            ...
            @if (Route::has('oner.login'))
                <div class="hidden fixed top-0 right-0 px-6 py-4 sm:block">
                    @auth('oner')
                        <li>Dashboard</li>
                        <li>Log out</li>
                    @else
                        <a href="{{ route('oner.login') }}" class="text-sm text-gray-700 dark:text-gray-500 underline">Oner
                            Log
                            in</a>

                        @if (Route::has('oner.register'))
                            <a href="{{ route('oner.register') }}"
                                class="ml-4 text-sm text-gray-700 dark:text-gray-500 underline">Oner Register</a>
                        @endif
                    @endauth
                </div>
            @endif
